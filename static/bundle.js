	...
	var TodoList = exports.TodoList = (0, _reactRedux.connect)(function mapStateToProps(state) {
	  ...
	  return {
	    ...
	    toggleTodo: function toggleTodo(id) {
	      return dispatch((0, _action.toggleTodo)(id));
	    },
	    deleteTodo: function deleteTodo(id) {
	      return dispatch((0, _action.deleteTodo)(id));
	    },
	    enableEditTodo: function enableEditTodo(id) {
	      return dispatch((0, _action.enableEditTodo)(id));
	    },
	    editTodo: function editTodo(id, text) {
	      return dispatch((0, _action.editTodo)(id, text));
	    }
	  };
	})(components.TodoList);
...
/***/ function(module, exports, __webpack_require__) {
	...
	function TodoList(props) {
	  ...
	  var enableEditTodo = props.enableEditTodo;
	    ...
	    _react2.default.createElement(
	      ...
	      todos.map(function (t) {
	        return _react2.default.createElement(
	          ...
	          _react2.default.createElement(_todo2.default, { todo: t.toJS(), togglefunction: function togglefunction() {
	              return toggleTodo(t.get('id'));
	            }, deletefunction: function deletefunction() {
	              return deleteTodo(t.get('id'));
	            }, enableEdit: function enableEdit() {
	              return enableEditTodo(t.get('id'));
	            }, editTodofunction: function editTodofunction(event) {
	              return updateTodo(event, t.get('id'));
	            } })
	        );
	      })
	    )
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Todo = function Todo(_ref) {
	    ...
	    var togglefunction = _ref.togglefunction;
	...
	Todo.propTypes = {
	    ...
	    deletefunction: _react.PropTypes.func.isRequired,
